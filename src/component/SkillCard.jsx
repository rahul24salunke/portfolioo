...
const SkillItem = ({ icon, text }) => (
  <div className="flex items-center gap-2 sm:gap-3 bg-[#1a1d22]/50 p-1.5 sm:p-2 rounded-lg border border-transparent hover:border-cyan-500/30 transition-all duration-200">
